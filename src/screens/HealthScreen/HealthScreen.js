...
const HealthScreen = () => {
    ...
    const addPost = () => {
        const randomItem = Config.HEALTH[Math.floor(Math.random() * Config.HEALTH.length)];
  ...
  return (
      <View style={styles.container}>
          <Text style={styles.heading}>Health Topic Pronunciation</Text>
      <Image source={Health} style={styles.image}></Image>
