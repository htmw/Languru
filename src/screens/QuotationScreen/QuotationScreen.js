...
import Quotation from '../../../assets/training_images/quote.png';
...
const QuotationScreen = () => {
    ...
    const addPost = () => {
    const randomItem = Config.QUOTATION[Math.floor(Math.random() * Config.QUOTATION.length)];
...
return (
    <View style={styles.container}>
        <Text style={styles.heading}>Quotation Topic Pronunciation</Text>
    <Image source={Quotation} style={styles.image}></Image>
